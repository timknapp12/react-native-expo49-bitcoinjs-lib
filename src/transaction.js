...
Transaction.prototype.hashForWitnessV0 = async function (
  inIndex,
  prevOutScript,
  value,
  hashType
  ...
  if (!(hashType & Transaction.SIGHASH_ANYONECANPAY)) {
    ...
    hashPrevouts = await bcrypto.hash256(tbuffer);
  }
  ...
  if (
    ...
    hashSequence = await bcrypto.hash256(tbuffer);
  }
  ...
  if (
    ...
    hashOutputs = await bcrypto.hash256(tbuffer);
  } else if (
    (hashType & 0x1f) === Transaction.SIGHASH_SINGLE &&
